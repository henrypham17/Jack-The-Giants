...
public class UIHud {
    ...
    public void createGameOverPanel(){
        ...
        gameOverPanel.setPosition(GameInfo.Width / 2f, GameInfo.Height / 2f,
                Align.center);

        endScore.setPosition(GameInfo.Width / 2f - 30, GameInfo.Height / 2f + 20,
                Align.center);
        endCoinScore.setPosition(GameInfo.Width / 2f - 30, GameInfo.Height / 2f - 90,
                Align.center);
